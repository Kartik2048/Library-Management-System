...
public class LibraryController {
    ...
    public ResponseEntity<Borrowing> borrowBook(@PathVariable Long bookId, @PathVariable Long memberId) {
        return ResponseEntity.ok(libraryService.borrowBook(bookId, memberId));
    }

    @PostMapping("/return/{borrowingId}")
    public ResponseEntity<Book> returnBook(@PathVariable Long borrowingId) {
